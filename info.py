...
BOT_TOKEN = environ.get('6212399137:AAG59qqOLn306rydBPF9pR8w7qeEX4UozgI')
...
# Bot Admins
ADMINS = [int(admins) if id_pattern.search(admins) else admins for admins in environ.get('ADMINS', '2068595855').split()]
auth_users = [int(auth_users) if id_pattern.search(auth_users) else auth_users for auth_users in environ.get('AUTH_USERS', '2068595855').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# Channels
INDEX_CHANNELS = [int(index_channels) if id_pattern.search(index_channels) else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1001829063349').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-1001912229299')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001920937423'))

# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://gdc846017:blackpanther00@cluster0.zpakafu.mongodb.net/?retryWrites=true&w=majority")
...
SHORTLINK_API = environ.get("SHORTLINK_API", "a7a676870a9f4dd48b05af485639db21d80e1293")
